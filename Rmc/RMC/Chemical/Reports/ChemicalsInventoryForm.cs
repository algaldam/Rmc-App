...
{
    public partial class ChemicalsInventoryForm : Telerik.WinControls.UI.RadForm
    {
        ...
        private string BODEGA_ID = "3";

        public ChemicalsInventoryForm()
        {
            InitializeComponent();
        ...
        private void btnInventario_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rgvDetalle.Columns.Count > 0) rgvDetalle.Columns[0].IsVisible = false;
